    ...
    <footer className="bg-white py-12 border-t border-gray-200">
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between mb-12">
          <div className="mb-8 md:mb-0">
            <Link to="/" className="text-xl font-bold flex items-center mb-4">
              <span className="text-blue-600">Brain</span>Scan
            </Link>
            <p className="text-gray-600 max-w-xs">
              Advanced AI-powered brain tumor detection and classification for medical professionals.
            </p>
          </div>
        ...
        <div className="pt-8 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-600 text-sm">© 2023 BrainScan. All rights reserved.</p>
